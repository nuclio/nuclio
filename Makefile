...
NUCLIO_DOCKER_DASHBOARD_UHTTPC_IMAGE_NAME   ?= gcr.io/iguazio/uhttpc
NUCLIO_DOCKER_DASHBOARD_UHTTPC_TAG 			?= 0.0.1
...
dashboard: build-builder
	docker build \
		...
		--build-arg NUCLIO_GO_LINK_FLAGS_INJECT_VERSION="$(GO_LINK_FLAGS_INJECT_VERSION)" \
		--build-arg UHTTPC_IMAGE_NAME="$(NUCLIO_DOCKER_DASHBOARD_UHTTPC_IMAGE_NAME)" \
		--build-arg UHTTPC_TAG="$(NUCLIO_DOCKER_DASHBOARD_UHTTPC_TAG)" \

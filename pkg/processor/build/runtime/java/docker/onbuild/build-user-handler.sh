...
# count how many jars there are in in /home/gradle/src/userHandler/src/main/java (this is where the onbuild docker
...
num_jars=$(ls -1 /home/gradle/src/userHandler/src/main/java/*.jar 2>/dev/null | wc -l)
...
# if there is 1 jar, use it as the user handler. Move it to the place it would've been built
    ...
    # move the jar there
    cp $(ls -1 /home/gradle/src/userHandler/src/main/java/*.jar) /home/gradle/src/userHandler/build/libs/user-handler.jar

/*
Package kotlin implements a Kotlin runtime
...
Build will work also if the path passed is a single Kotlin file.


You can specify dependencies using (inline in Kotlin file or Jar) build configuration

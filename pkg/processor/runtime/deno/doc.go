...
/*
package deno implements deno runtime

deno code need to export a handler function:
...
In nuclio/handler-deno-alpine image NODE_PATH is set to /usr/local/lib/node_modules
*/
package deno

...
import (
	v1beta1 "github.com/nuclio/nuclio/pkg/platform/kube/clients/nuclio/clientset/versioned/typed/nuclio.io/v1beta1"
...
func (c *FakeNuclioV1beta1) NuclioAPIGateways(namespace string) v1beta1.NuclioAPIGatewayInterface {

...
import (
	"context"
	"github.com/nuclio/nuclio/pkg/platform/kube/clients/nuclio/clientset/versioned/scheme"
	"time"
...
func (c *nuclioFunctionEvents) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.NuclioFunctionEvent, err error) {
...
func (c *nuclioFunctionEvents) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.NuclioFunctionEventList, err error) {
...
func (c *nuclioFunctionEvents) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *nuclioFunctionEvents) Create(ctx context.Context, nuclioFunctionEvent *v1beta1.NuclioFunctionEvent, opts v1.CreateOptions) (result *v1beta1.NuclioFunctionEvent, err error) {
	result = &v1beta1.NuclioFunctionEvent{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("nucliofunctionevents").
...
func (c *nuclioFunctionEvents) Update(ctx context.Context, nuclioFunctionEvent *v1beta1.NuclioFunctionEvent, opts v1.UpdateOptions) (result *v1beta1.NuclioFunctionEvent, err error) {
	result = &v1beta1.NuclioFunctionEvent{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("nucliofunctionevents").
...
func (c *nuclioFunctionEvents) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *nuclioFunctionEvents) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *nuclioFunctionEvents) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.NuclioFunctionEvent, err error) {
	result = &v1beta1.NuclioFunctionEvent{}

...
func (suite *FunctionKubePlatformTestSuite) TestValidateAPIGatewayAuthentication() {
	for _, testCase := range []struct {
		...
		},
		{
			...
			authenticationMode: ingress.AuthenticationModeIguazio,
			annotations: map[string]string{
				annotations.AnnotationNginxAuthResponseHeaders: "test-header",
				annotations.AnnotationNginxProxyBodySize:       "100",
				annotations.AnnotationNginxProxyBufferSize:     "200",
				annotations.AnnotationNginxServiceUpstream:     "false",
				annotations.AnnotationNginxSSLRedirect:         "false",
				annotations.AnnotationNginxAuthURL:             "test-url",
				annotations.AnnotationNginxAuthSignIn:          "test-sign-in",
			},
			expectError: true,
		},
		{

...
func (d *deleter) delete(consumer *consumer, deleteOptions *platform.DeleteOptions) error {
	...
	resourceName, _, err := nuctl.ParseResourceIdentifier(deleteOptions.FunctionConfigs[0].Meta.Name)
	if err != nil {
		return errors.Wrap(err, "Failed to parse resource identifier")
	}

	// get specific function CR
	err = consumer.functioncrClient.Delete(deleteOptions.FunctionConfigs[0].Meta.Namespace, resourceName, &meta_v1.DeleteOptions{})
	if err != nil {

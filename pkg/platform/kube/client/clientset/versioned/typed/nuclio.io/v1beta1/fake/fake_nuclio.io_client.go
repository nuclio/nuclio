...
func (c *FakeNuclioV1beta1) Functions(namespace string) v1beta1.FunctionInterface {
	return &FakeFunctions{c, namespace}
}

func (c *FakeNuclioV1beta1) FunctionEvents(namespace string) v1beta1.FunctionEventInterface {
	return &FakeFunctionEvents{c, namespace}
}

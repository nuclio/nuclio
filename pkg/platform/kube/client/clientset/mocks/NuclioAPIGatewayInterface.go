...
func (_m *NuclioAPIGatewayInterface) Create(_a0 *v1beta1.NuclioAPIGateway) (*v1beta1.NuclioAPIGateway, error) {
	ret := _m.Called(_a0)

	var r0 *v1beta1.NuclioAPIGateway
	if rf, ok := ret.Get(0).(func(*v1beta1.NuclioAPIGateway) *v1beta1.NuclioAPIGateway); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*v1beta1.NuclioAPIGateway) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *NuclioAPIGatewayInterface) Delete(name string, options *v1.DeleteOptions) error {
...
func (_m *NuclioAPIGatewayInterface) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
...
func (_m *NuclioAPIGatewayInterface) Get(name string, options v1.GetOptions) (*v1beta1.NuclioAPIGateway, error) {
	ret := _m.Called(name, options)

	var r0 *v1beta1.NuclioAPIGateway
	if rf, ok := ret.Get(0).(func(string, v1.GetOptions) *v1beta1.NuclioAPIGateway); ok {
		r0 = rf(name, options)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1beta1.NuclioAPIGateway)
...
func (_m *NuclioAPIGatewayInterface) List(opts v1.ListOptions) (*v1beta1.NuclioAPIGatewayList, error) {
	ret := _m.Called(opts)

	var r0 *v1beta1.NuclioAPIGatewayList
	if rf, ok := ret.Get(0).(func(v1.ListOptions) *v1beta1.NuclioAPIGatewayList); ok {
		r0 = rf(opts)
	} else {
		if ret.Get(0) != nil {
...
func (_m *NuclioAPIGatewayInterface) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (*v1beta1.NuclioAPIGateway, error) {
	...
	var r0 *v1beta1.NuclioAPIGateway
	if rf, ok := ret.Get(0).(func(string, types.PatchType, []byte, ...string) *v1beta1.NuclioAPIGateway); ok {
...
func (_m *NuclioAPIGatewayInterface) Update(_a0 *v1beta1.NuclioAPIGateway) (*v1beta1.NuclioAPIGateway, error) {
	ret := _m.Called(_a0)
...
func (_m *NuclioAPIGatewayInterface) UpdateStatus(_a0 *v1beta1.NuclioAPIGateway) (*v1beta1.NuclioAPIGateway, error) {
	ret := _m.Called(_a0)
...
func (_m *NuclioAPIGatewayInterface) Watch(opts v1.ListOptions) (watch.Interface, error) {
	ret := _m.Called(opts)

...
func (_m *NuclioFunctionInterface) Create(_a0 *v1beta1.NuclioFunction) (*v1beta1.NuclioFunction, error) {
	ret := _m.Called(_a0)

	var r0 *v1beta1.NuclioFunction
	if rf, ok := ret.Get(0).(func(*v1beta1.NuclioFunction) *v1beta1.NuclioFunction); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*v1beta1.NuclioFunction) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *NuclioFunctionInterface) Delete(name string, options *v1.DeleteOptions) error {
...
func (_m *NuclioFunctionInterface) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
...
func (_m *NuclioFunctionInterface) Get(name string, options v1.GetOptions) (*v1beta1.NuclioFunction, error) {
	ret := _m.Called(name, options)

	var r0 *v1beta1.NuclioFunction
	if rf, ok := ret.Get(0).(func(string, v1.GetOptions) *v1beta1.NuclioFunction); ok {
		r0 = rf(name, options)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1beta1.NuclioFunction)
...
func (_m *NuclioFunctionInterface) List(opts v1.ListOptions) (*v1beta1.NuclioFunctionList, error) {
	ret := _m.Called(opts)

	var r0 *v1beta1.NuclioFunctionList
	if rf, ok := ret.Get(0).(func(v1.ListOptions) *v1beta1.NuclioFunctionList); ok {
		r0 = rf(opts)
	} else {
		if ret.Get(0) != nil {
...
func (_m *NuclioFunctionInterface) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (*v1beta1.NuclioFunction, error) {
	...
	var r0 *v1beta1.NuclioFunction
	if rf, ok := ret.Get(0).(func(string, types.PatchType, []byte, ...string) *v1beta1.NuclioFunction); ok {
...
func (_m *NuclioFunctionInterface) Update(_a0 *v1beta1.NuclioFunction) (*v1beta1.NuclioFunction, error) {
	ret := _m.Called(_a0)
...
func (_m *NuclioFunctionInterface) UpdateStatus(_a0 *v1beta1.NuclioFunction) (*v1beta1.NuclioFunction, error) {
	ret := _m.Called(_a0)
...
func (_m *NuclioFunctionInterface) Watch(opts v1.ListOptions) (watch.Interface, error) {
	ret := _m.Called(opts)

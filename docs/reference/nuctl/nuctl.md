...
- [Overview](#overview)
- [Download and Installation](#download-and-install)
- [Usage](#usage)
- [The running platform](#the-running-platform)
...
For an example of function deployment using `nuctl` against a Kubernetes cluster, see the Nuclio [Kubernetes getting-started guide](../../setup/k8s/getting-started-k8s.md).

#### Invoking a function using nuctl on Kubernetes

While in most cases using `nuctl` on the [Local Docker](#local-docker) platform enables you to invoke your function by running the

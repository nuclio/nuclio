...
| triggers.(name).workerTerminationTimeout                             | string                                                                                                     | Waiting time for workers to drop or ACK on events before rebalance in seconds or as a duration string (e.g., `5s`, `1m`, `1h`); `10s` by default                                                                                                                                                                  |

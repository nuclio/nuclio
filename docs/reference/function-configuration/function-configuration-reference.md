...
| <a id="spec.build.path"></a>build.path | string | Function-code GitHub directory or archive-file path for the `github` or `archive` [code-entry type](#spec.build.codeEntryType); see [Code-Entry Types](/docs/reference/function-configuration/code-entry-types.md#external-source-code-entry-types) |
...
| build.baseImage | string | The URL of the base image from which the function processor image will be built |

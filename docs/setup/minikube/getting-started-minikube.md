...
> [expose your function](/docs/user%20guide/deploying-functions.md#exposing-a-function).
...
> purposes only. Please read more about [exposing your function](/docs/user%20guide/deploying-functions.md#exposing-a-function)

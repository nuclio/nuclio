...
func main() {
	...
	functionOperatorResyncIntervalString := flag.String("function-operator-resync-interval", common.GetEnvOrDefaultString("NUCLIO_CONTROLLER_FUNCTION_OPERATOR_RESYNC_INTERVAL", "10m"), "Set resync interval for the function operator (optional)")
	...
	if err := app.Run(*kubeconfigPath,
		...
		*functionOperatorResyncIntervalString,
